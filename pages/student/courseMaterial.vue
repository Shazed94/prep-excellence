...
const storeName='student/course_material'
export default {
  name: 'studentCourse',
  components: {Sidebar},
  mixins: [commonMixin],
  data() {
    return {
      pageInfo: {
        ...
        apiUrl: '/student/course/materials/',
      },
      state: {
        name: stateName,
  ...
  computed: {
    ...mapGetters('student/course_material',['course_materials','totalItems']),
    selectedIds() {
  ...
  async mounted() {
    ...
    if (!this.course_materials.length) await this.init();
