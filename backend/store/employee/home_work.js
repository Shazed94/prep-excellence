export default {
  ...
  mutations: {
    ...
    UPDATE_SINGLE_MARK(state, payload) {
      console.log('working')
      //Object.assign(state.home_works[payload.index1].studentHomeWorks[payload.index2].mark, payload.mark)
      state.home_works[payload.index1].studentHomeWorks[payload.index2].mark = payload.mark
    },
