<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Mange Course',disabled: false, href: '/admin/course/course'},{text: `${pageInfo.pageName}`,disabled: true, href: '/admin/course/category'}]"
    />
    <v-card>
      <v-data-table
        dense
...
const permission = 'Course Category'
...
export default {
  ...
  computed: {
    ...mapGetters('admin/courseCategory',['course_categories','totalItems']),
    selectedIds() {
