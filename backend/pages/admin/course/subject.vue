<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Mange Course',disabled: false, href: '/admin/course/course'},{text: `${pageInfo.pageName}`,disabled: true, href: '/admin/course/subject'}]"
    />
    <v-card>
      <v-data-table
        dense
...
export default {
  ...
  computed: {
    ...mapGetters('admin/subject',['subjects','totalItems']),
    selectedIds() {
