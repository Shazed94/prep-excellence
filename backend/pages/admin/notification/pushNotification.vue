  ...
  <v-container fluid>
    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:item.is_seen="{ index, item }">
          <v-chip  v-if="item.is_seen" color="green" filter>Yes</v-chip>
          <v-chip  v-else color="yellow" filter>No</v-chip>
        </template>
      </v-data-table>
    </v-card>
  </v-container>
...
const permission = 'Push Notification'
const stateName = 'push_notifications'
const storeName='admin/notification/push'
...
export default {
  ...
  computed: {
    ...mapGetters('admin/notification/push',['push_notifications','totalItems']),
