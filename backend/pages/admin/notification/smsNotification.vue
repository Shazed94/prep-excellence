...
const permission = 'Sms Notification'
const stateName = 'sms_notifications'
const storeName='admin/notification/sms'
...
export default {
  ...
  computed: {
    ...mapGetters('admin/notification/sms',['sms_notifications','totalItems']),
