<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Test & Results',disabled: false, href: '/admin/exam'},{text: `${pageInfo.pageName}`,disabled: true, href: '/admin/exam/question/sat/{id}'}]"
    />
    <v-card>
      <validation-observer ref="observer" v-slot="{ invalid }">
        <v-form ref="form" @submit.prevent="submitData()">
          <v-card-title class="text-h5">
            {{ editIndex > -1 ? 'Update ' : 'Create' }} {{ pageInfo.pageName | capitalize }}<br>
            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="12" xs="12" sm="4" v-if="form.question_type === 2">
                  ...
                  <div v-if="exam.question">Uploaded question: <a :href="exam.question" target="_blank">Click</a></div>
                </v-col>
                <v-col cols="12" xs="12" sm="4">
                  <validation-provider
                    v-slot="{ errors }"
