<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Test & Results',disabled: false, href: '/admin/exam'},{text: `${pageInfo.pageName}`,disabled: true, href: '/admin/exam/score'}]"
    />
    <v-card>
      <v-data-table
        dense
      ...
      >
        ...
        <template v-slot:item.actions="{index, item }">
          <v-tooltip bottom v-if="$can('read',pageInfo.permission)">
            <template v-slot:activator="{ on, attrs }">
...
const permission = 'Section & Test Score'
const stateName = 'sat_scores'
const storeName='admin/sat_score'
export default {
  ...
  computed: {
    ...mapGetters('admin/sat_score',['sat_scores','totalItems']),
    selectedIds() {
