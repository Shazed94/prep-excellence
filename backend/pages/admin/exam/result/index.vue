<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Test & Results',disabled: false, href: '/admin/exam'},{text: `${pageInfo.pageName}`,disabled: true, href: '/admin/exam/result'}]"
    />
    <v-card>
      <v-data-table
        dense
...
export default {
  ...
  async mounted() {
    ...
    if (!this.results.length) await this.init();
