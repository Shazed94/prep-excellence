<template>
  <v-container fluid>
    <bread-crumbs
      ...
      :items="[{text: 'Course',disabled: false, href: '/student/course'},{text: `${pageInfo.pageName}`,disabled: true, href: '/student/schedule'}]"
    />
    <v-card>
...
export default {
  ...
  methods: {
    async init(start,end) {
      ...
      let url = `/student/course/schedule?start_date=${start}&end_date=${end}`
