...
class ApplicantStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sat_score_english' => ['nullable','string', 'max:191'],
            'sat_score_math' => ['nullable','string', 'max:191'],
            'sat_score_total' => ['nullable','string', 'max:191'],
            ...
            'willing_topics' => ['nullable','string'],
