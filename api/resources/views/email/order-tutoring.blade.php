...
@section('master')
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                            <strong>Order Number:</strong> {{ $orders->tnx_no }} | <strong>Order Date:</strong> {{date('m/d/Y', strtotime($orders->created_at))}}
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    @foreach(json_decode($orders->courses,false)  as $order)
        <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 14px; line-height: 18px; color: #757575; padding-bottom: 10px;">
                            <b style="color: #666666;">{{$order->hour}}</b> Hour
                        </td>
                        <td style="font-size: 14px; line-height: 18px; color: #757575; text-align: right; padding-bottom: 10px;">
                            <b style="color: #666666;">{{'$' . ($orders->hour_rate * $order->hour)}}</b> Total
                        </td>
                    </tr>
                </tbody>
            </table>
